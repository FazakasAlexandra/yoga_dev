      ...
      <div className='class wraper'>
        <div className='class info-wraper'>
          ...
          <div className='class radio'>
            <p className={active ? 'bold-text' : 'thin-text'}>
              {yogaClass.name || yogaClass.class_name}
            </p>
            {minimal ? null : (
              <RadioGroup
              ...
              >
                <FormControlLabel
                  value='offline'
                  control={
                    <Radio {...controlProps('offline')} color='primary' />
                  }
                  label='offline'
                />
                ...
                <FormControlLabel
                  value='online'
                  control={
                    <Radio {...controlProps('online')} color='primary' />
                  }
                  label='online'
                />
              </RadioGroup>
        ...
        {minimal ? null : isBooked ? (
          'BOOKED'
        ) : (
          <a
            className='button-white'
            onClick={() => !userData ? signIn() : handleBookClick(yogaClass)}
          >
            Book
          </a>
        )}
