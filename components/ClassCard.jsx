...
export default function ClassCard({ id, name, offprice, onprice, attend, deletion }) {
    const newTo = { 
    ...
    return (
        <div className="class-card">
            ...
            <div className="classCardDetails">
                ...
                <p><b>Offline price:</b> {offprice}</p>
                <p><b>Online price:</b> {onprice}</p>
                <p><b>Attendences:</b> {attend}</p>
            </div>
        </div>
    )
  }
